...
def md5(message):
    ...
    for i in range(0, len(message), 64):
        ...
        for j in range(64):
            ...
            # Các hằng số MD5 thực tế tương ứng với từng vòng lặp (giá trị tượng trưng trong ảnh mẫu dòng 44)
            # Lưu ý: Đoạn tính toán dưới đây bám sát theo ảnh mẫu của bạn
            temp = d
            d = c
            c = b
